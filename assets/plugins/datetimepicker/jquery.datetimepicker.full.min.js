      ...
      parseFormat: function (e, a) {
        ...
        return (
          (n = {
            ...
            c: function () {
              return "Y-m-d\\TH:i:sP".replace(s, d);
            },
            r: function () {
              return "D, d M Y H:i:s O".replace(s, d);
            },
            U: function () {
              ...
              (a > 0 && "\\" === t.charAt(a - 1)
                ...
                : ((o = s.parseFormat(i, e)),
                  a !== r - 1 &&
                    s.intParts.test(i) &&
                    "S" === t.charAt(a + 1) &&
                    ((n = parseInt(o) || 0), (o += s.dateSettings.ordinal(n))),
                  (d += o)));
          return d;
        }
        return "";
          ...
          ? (e(this).hasClass("xdsoft_scroller_box") ||
              ...
              d
                .on("scroll_element.xdsoft_scroller", function (e, t) {
                  r || d.trigger("resize_scroll.xdsoft_scroller", [t, !0]),
                    ...
                    (l = parseFloat(
                      Math.abs((n[0].offsetHeight - r) * t).toFixed(4),
                    )),
                    s.css("marginTop", f * t),
                    n.css("marginTop", -l);
                })
                .on("resize_scroll.xdsoft_scroller", function (e, t, a) {
                  ...
                  (r = d[0].clientHeight),
                    ...
                    u > 1
                      ? s.hide()
                      : (s.show(),
                        s.css("height", parseInt(c > 10 ? c : 10, 10)),
              ...
              d.on("mousewheel", function (e) {
                var t = (function (e) {
                  ...
                  a = Math.max(0, l - t);
                return (
                  d.trigger("scroll_element.xdsoft_scroller", [a / (o - r)]),
                  e.stopPropagation(),
                  !1
                );
              }),
                ...
                (o = setTimeout(function () {
                  ...
                  if (!1 !== M.minDateTime) {
                    ...
                    if (
                      ...
                      (j = 60 * Y.getHours() + Y.getMinutes()) > F && (F = j);
                  }
                  if (!1 !== M.maxDateTime) {
                    var j;
                    ...
                    if (
                      ...
                      (j = 60 * Y.getHours() + Y.getMinutes()) < A && (A = j);
                  }
                  if (
                    ((c = function (n, r) {
                      var o,
  ...
  (function (e) {
    ...
    function d(n) {
      ...
      if (
        ...
        "axis" in r && r.axis === r.HORIZONTAL_AXIS && ((f = -1 * c), (c = 0)),
        (d = 0 === c ? f : c),
        "deltaY" in r && (d = c = -1 * r.deltaY),
        "deltaX" in r && ((f = r.deltaX), 0 === c && (d = -1 * f)),
        0 !== c || 0 !== f)
      ) {
        if (1 === r.deltaMode) {
        ...
        if (
          ...
          (!a || m < a) && ((a = m), l(r, m) && (a /= 40)),
          l(r, m) && ((d /= 40), (f /= 40), (c /= 40)),
