                        ...
                        <div class="perfexdashboard-actions-wrap perfexdashboard-actions-wrap-between">
                            ...
                            <div class="perfexdashboard-actions-section-right">
                                <div class="perfexdashboard-period-select">
                                    <?php
                                    $tmp_req_from = DateTime::createFromFormat('d-m-Y', $this->input->get('period_from'));
                                    if ($tmp_req_from !== false) {
                                        $tmp_req_from = $tmp_req_from->format('d-m-Y');
                                    } else {
                                        $tmp_req_from = null;
                                    }

                                    $tmp_req_to = DateTime::createFromFormat('d-m-Y', $this->input->get('period_to'));
                                    if ($tmp_req_to !== false) {
                                        $tmp_req_to = $tmp_req_to->format('d-m-Y');
                                    } else {
                                        $tmp_req_to = null;
                                    }
