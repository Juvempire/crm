...
class Sms_melipayamak extends App_sms
{
    ...
    public function __construct()
    {
        ...
        $this->add_gateway('melipayamak', [
            'name'    => 'ملی پیامک',
            'info'    => "<p>ارسال کلیه پیامک‌های سیستم از طریق سامانه پیامکی <a href='https://melipayamak.com' target='_blank'>ملی پیامک</a> - طراحی و توسطعه داده شده توسط <a href='https://taskify.ir' target='_blank'>تسکیفای</a></p><hr class='hr-10'>",
            'options' => [
                [
                    'name'  => 'from',
                    'label' => 'شماره فرستنده',
